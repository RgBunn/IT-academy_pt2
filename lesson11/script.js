...
// },Math.random()*10000);
//
// const askMoneyIntervalId= setInterval(()=>{
//     if(cashFromSanya>0){
//         clearInterval(askMoneyIntervalId);
//         console.log(`Sanya returned ${cashFromSanya}`);
//     }
//     else{
//         console.log(`Sanya didnt return anything`)
//     }
// },1000);
/////////////////////////////////////////////////////////////
...
//     .then(
//         function(param){
//             console.log('done after reject',param)
//         })
//     .finally(function() {
//         console.log('finally')
//     })
...
//             setTimeout(reject,500,'response with error')
//     })
// }
// getDatafromServer()
//     .then(data => {
...
// const getData=()=>Promise.resolve({hello:"world"});
//
// async function test(){
